...
class Credentials(
    ...
    def __init__(
        ...
        Args:
            ...
            service_id_token (str): The service account ID passed into
        ...
        self._service_id_token = service_id_token
        self._signer = Signer()
    ...
    def refresh(self, request):
        ...
        token, ttl = app_identity.get_access_token(scopes, self._service_id_token)
    ...
    def service_account_email(self):
        ...
        if self._service_id_token is None:
            self._service_id_token = app_identity.get_service_account_name()
        return self._service_id_token
    ...
    def with_scopes(self, scopes, default_scopes=None):
        return self.__class__(
            ...
            service_id_token=self._service_id_token,
